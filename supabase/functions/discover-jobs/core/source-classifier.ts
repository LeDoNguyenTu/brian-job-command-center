...
const RULES: FingerprintRule[] = [
  ...
  { provider: "successfactors", adapter: "generic_employer_html", sourceClass: "generic_employer", html: /successfactors\.(?:com|eu)|career\d*\.successfactors/i },
  { provider: "oracle", adapter: "generic_employer_html", sourceClass: "generic_employer", html: /hcmUI\/CandidateExperience|oraclecloud|taleo/i },
  { provider: "icims", adapter: "generic_employer_html", sourceClass: "generic_employer", html: /(?:^|[./])icims\.com|icims/i },
  { provider: "pageup", adapter: "generic_employer_html", sourceClass: "generic_employer", html: /pageuppeople\.com|PageUp/i },
